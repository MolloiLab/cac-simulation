...
begin
	array_s_80 = hcat(df_s_80[!, :calculated_swcs_large], df_s_80[!, :calculated_swcs_medium], df_s_80[!, :calculated_swcs_small])
	array_s_100 = hcat(df_s_100[!, :calculated_swcs_large], df_s_100[!, :calculated_swcs_medium], df_s_100[!, :calculated_swcs_small])
	array_s_120 = hcat(df_s_120[!, :calculated_swcs_large], df_s_120[!, :calculated_swcs_medium], df_s_120[!, :calculated_swcs_small])
	array_s_135 = hcat(df_s_135[!, :calculated_swcs_large], df_s_135[!, :calculated_swcs_medium], df_s_135[!, :calculated_swcs_small])
end;
...
begin
	array_i_80 = hcat(df_i_80[!, :calculated_mass_large], df_i_80[!, :calculated_mass_medium], df_i_80[!, :calculated_mass_small])
	array_i_100 = hcat(df_i_100[!, :calculated_mass_large], df_i_100[!, :calculated_mass_medium], df_i_100[!, :calculated_mass_small])
	array_i_120 = hcat(df_i_120[!, :calculated_mass_large], df_i_120[!, :calculated_mass_medium], df_i_120[!, :calculated_mass_small])
	array_i_135 = hcat(df_i_135[!, :calculated_mass_large], df_i_135[!, :calculated_mass_medium], df_i_135[!, :calculated_mass_small])
end;
...
function zero_cac_plot()
	...
	axtop = Axis(
		f[1, 1], 
		xticks = (1:3, ["Integrated", "Spatially Weighted", "Agatston"]),
	)
	...
	save("/Users/daleblack/Google Drive/Research/Papers/My Papers/cac-simulation/figures/zero_cac_motion.png", f)
	f
end
...
function lin_reg_norm()
	...
	save("/Users/daleblack/Google Drive/Research/Papers/My Papers/cac-simulation/figures/linear_reg_norm_motion.png", f)
	f
end
...
function lin_reg_low()
	...
	errorbars!(ax1, df2[!, :ground_truth_mass_large], df2[!, :calculated_mass_large], rms(df2[!, :ground_truth_mass_large], df2[!, :calculated_mass_large]))
	sc2 = scatter!(ax1, df2[!, :ground_truth_mass_medium], df2[!, :calculated_mass_medium])
	errorbars!(ax1, df2[!, :ground_truth_mass_medium], df2[!, :calculated_mass_medium], rms(df2[!, :ground_truth_mass_medium], df2[!, :calculated_mass_medium]))
	sc3 = scatter!(ax1, df2[!, :ground_truth_mass_small], df2[!, :calculated_mass_small], color=:red)
	errorbars!(ax1, df2[!, :ground_truth_mass_small], df2[!, :calculated_mass_small], rms(df2[!, :ground_truth_mass_small], df2[!, :calculated_mass_small]))
	...
	errorbars!(ax2, df4[!, :ground_truth_mass_large], df4[!, :calculated_mass_large], rms(df4[!, :ground_truth_mass_large], df4[!, :calculated_mass_large]))
	sc2 = scatter!(ax2, df4[!, :ground_truth_mass_medium], df4[!, :calculated_mass_medium])
	errorbars!(ax2, df4[!, :ground_truth_mass_medium], df4[!, :calculated_mass_medium], rms(df4[!, :ground_truth_mass_medium], df4[!, :calculated_mass_medium]))
	sc3 = scatter!(ax2, df4[!, :ground_truth_mass_small], df4[!, :calculated_mass_small], color=:red)
	errorbars!(ax2, df4[!, :ground_truth_mass_small], df4[!, :calculated_mass_small], rms(df4[!, :ground_truth_mass_small], df4[!, :calculated_mass_small]))
	ln1 = lines!(ax2, [-1000, 1000], [-1000, 1000])
	...
	save("/Users/daleblack/Google Drive/Research/Papers/My Papers/cac-simulation/figures/linear_reg_low_motion.png", f)
	f
end
...
array_k = hcat(df_a[!, :ground_truth_mass_large], df_a[!, :ground_truth_mass_medium], df_a[!, :ground_truth_mass_small]);
...
array_i_r = hcat(df_i_r[!, :calculated_mass_large], df_i_r[!, :calculated_mass_medium], df_i_r[!, :calculated_mass_small])
...
let
	r_array = [Tuple(df_i_r[!, :calculated_mass_large])..., Tuple(df_i_r[!, :calculated_mass_medium])..., Tuple(df_i_r_small[!, :calculated_mass_small])...]
	calc_array = [Tuple(df_i[!, :calculated_mass_large])..., Tuple(df_i[!, :calculated_mass_medium])..., Tuple(df_i_small[!, :calculated_mass_small])...]
	data = DataFrame(
		X = r_array,
		Y= calc_array
	)
...
array_a_r = hcat(df_a_r[!, :calculated_mass_large], df_a_r[!, :calculated_mass_medium], df_a_r[!, :calculated_mass_large]);
...
let
	r_array = [Tuple(df_a_r_large[!, :calculated_mass_large])..., Tuple(df_a_r_med[!, :calculated_mass_medium])..., Tuple(df_a_r_small[!, :calculated_mass_small])...]
	calc_array = [Tuple(df_a_large[!, :calculated_mass_large])..., Tuple(df_a_med[!, :calculated_mass_medium])..., Tuple(df_a_small[!, :calculated_mass_small])...]
	data = DataFrame(
		X = r_array,
		Y= calc_array
	)
...
array_s_r = hcat(df_s_r[!, :calculated_swcs_large], df_s_r[!, :calculated_swcs_medium], df_s_r[!, :calculated_swcs_small]);
...
let
	r_array = [Tuple(df_s_r_large[!, :calculated_mass_large])..., Tuple(df_s_r_med[!, :calculated_mass_medium])..., Tuple(df_s_r_small[!, :calculated_mass_small])...]
	calc_array = [Tuple(df_s_large[!, :calculated_mass_large])..., Tuple(df_s_med[!, :calculated_mass_medium])..., Tuple(df_s_small[!, :calculated_mass_small])...]
	data = DataFrame(
		X = r_array,
		Y= calc_array
	)
...
function reprod()
	...
	scatter!(ax1, df_i_r_small[!, :calculated_mass_small], df_i_small[!, :calculated_mass_small], color=:red)
	...
	##-- B --##
	ax2 = Axis(f[2, 1])
	scatter!(ax2, df_a_r_large[!, :calculated_mass_large], df_a_large[!, :calculated_mass_large], label="Large Inserts")
	scatter!(ax2, df_a_r_med[!, :calculated_mass_medium], df_a_med[!, :calculated_mass_medium], label="Medium Inserts")
	scatter!(ax2, df_a_r_small[!, :calculated_mass_small], df_a_small[!, :calculated_mass_small], label="Small Inserts", color=:red)
	...
	# ##-- C --##
	ax3 = Axis(f[3, 1])
	scatter!(ax3, df_s_r_large[!, :calculated_swcs_large], df_s_large[!, :calculated_swcs_large], label="Large Inserts")
	scatter!(ax3, df_s_r_med[!, :calculated_swcs_medium], df_s_med[!, :calculated_swcs_medium], label="Medium Inserts")
	scatter!(ax3, df_s_r_small[!, :calculated_swcs_small], df_s_small[!, :calculated_swcs_small], label="Small Inserts", color=:red)
	...
	save("/Users/daleblack/Google Drive/Research/Papers/My Papers/cac-simulation/figures/reprod_motion.png", f)
	f
end
