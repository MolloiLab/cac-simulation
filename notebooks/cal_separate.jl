...
for e in energies
	for d in densities
		path = string("/Users/daleblack/Google Drive/dev/MolloiLab/cac_simulation/mat_files/calibration/", d, "rod", e, ".mat")
		vars1 = matread(path)
		...
		output_root1 = string("/Users/daleblack/Google Drive/dev/MolloiLab/cac_simulation/cal_images")
